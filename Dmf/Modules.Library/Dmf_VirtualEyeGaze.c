...
Abstract:
    ...
    Supports a virtual eye gaze device.
...
} TRACKER_STATUS_REPORT;

typedef struct _TRACKER_CONTROL_REPORT
{
    UCHAR ReportId;
    UCHAR ModeRequest;
} TRACKER_CONTROL_REPORT;
...
--*/
{
    ...
    RtlZeroMemory(&capabilitiesReport->CapabilitiesData,
    ...
    RtlZeroMemory(&configurationReport->ConfigurationData,
    ...
    // TODO: Get primary monitor information when using User-mode VHF when 
...
Routine Description:
    ...
    Sets the given configuration data to the device.

Arguments:

    DmfModule - This Module's handle.
    ConfigurationData - The given configuration data.
...
Routine Description:
    ...
    Sets the given capabilities settings to the device.

Arguments:

    DmfModule - This Module's handle.
    CapabilitiesData - The given capabilities settings.
...
Routine Description:
    ...
    Gets the current tracker control mode.

Arguments:

    DmfModule - This Module's handle.
    Mode - The returned tracker control mode.
...
--*/
{
    ...
    *Mode = trackerControlReport->ModeRequest;
