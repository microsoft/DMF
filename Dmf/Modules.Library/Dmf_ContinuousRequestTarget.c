...
ContinuousRequestTarget_PendingCollectionReuseListSearch(
    _In_ DMFMODULE DmfModule,
    _In_ RequestTarget_DmfRequestReuse UniqueRequestId,
...
--*/
{
    ...
    *RequestToReuse = NULL;
    ...
    // Iterate through the list looking for the request that corresponds witht he cookie.
    //
    currentItemIndex = 0;
    do 
    {
        ...
        if (uniqueRequestId->UniqueRequestIdReuse == (LONGLONG)UniqueRequestId)
        {
...
ContinuousRequestTarget_RequestSendReuse(
    ...
    _Inout_ RequestTarget_DmfRequestCancel* DmfRequestIdCancel
    )
/*++
...
--*/
{
    ...
    if (!returnValue)
    {
        ...
        //
        TraceEvents(TRACE_LEVEL_ERROR, DMF_TRACE, "ContinuousRequestTarget_PendingCollectionListSearchAndReference fails");
...
--*/
{
    ...
    if (moduleContext->PendingReuseRequests != NULL)
    {
        while (WdfCollectionGetCount(moduleContext->PendingReuseRequests))
        {
