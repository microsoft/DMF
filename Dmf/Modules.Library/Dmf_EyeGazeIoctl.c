...
--*/
{
    ...
    DMF_CONFIG_VirtualEyeGaze_AND_ATTRIBUTES_INIT(&moduleConfigVirtualEyeGaze,
                                                  &moduleAttributes);
    moduleConfigVirtualEyeGaze.ProductId = HIDMINI_PID;
    moduleConfigVirtualEyeGaze.VendorId = HIDMINI_VID;
    moduleConfigVirtualEyeGaze.VersionNumber = HIDMINI_VERSION;
